...
{
  iCyklCzasu = cykl;
  pokoj1 = pokoik1; st1 = ster1;
  pokoj2 = pokoik2; st2 = ster2;
  pokoj3 = pokoik3; st3 = ster3;
  pokoj4 = pokoik4; st4 = ster4;
  pokoj5 = pokoik5; st5 = ster5;
}
...
if (a == "poddaszeokno+") { pokoj1->plus += 0.5; cout << "Okno na poddaszu otwarte."; }
if (a == "poddaszeokno-") { pokoj1->plus -= 0.5; cout << "Okno na poddaszu zamkniete."; }
if (a == "salonokno+"){pokoj2->plus += 0.5; cout << "Okno w salonie otwarte.";}
if (a == "salonokno-"){pokoj2->plus -= 0.5; cout << "Okno w salonie zamkniete.";}
if (a == "sypialniaokno+"){pokoj3->plus += 0.5; cout << "Okno w sypialni otwarte.";}
if (a == "sypialniaokno-"){pokoj3->plus -= 0.5; cout << "Okno w sypialni zamkniete.";}
